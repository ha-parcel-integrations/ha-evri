...
CONFIGURATION_URL = "https://www.evri.com/track-a-parcel"

ATTRIBUTION = "Data provided by Evri"


def _display_postcode(value: str) -> str:
    return f"{value[:-3]} {value[-3:]}" if len(value) > 3 else value
...
def build_device_info(entry: ConfigEntry) -> DeviceInfo:
    ...
    return DeviceInfo(
        ...
        name=f"Evri ({_display_postcode(entry.options.get(CONF_POSTAL_CODE, ''))})",
        manufacturer="Evri",
