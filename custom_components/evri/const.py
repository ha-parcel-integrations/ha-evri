"""Constants for the Evri parcel tracker integration."""
...
# this repo.
REFERENCE_URL = (
    "https://tracking.platform-apis.evri.com/v1/parcels/reference/{tracking_code}"
)
DETAIL_URL = "https://tracking.platform-apis.evri.com/v1/parcels"
TRACKING_URL = "https://www.evri.com/track/parcel/{tracking_code}/details"
