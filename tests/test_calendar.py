"""Tests for the Evri deliveries calendar."""

from datetime import datetime, timezone
from unittest.mock import MagicMock

from custom_components.evri.calendar import EvriDeliveriesCalendar
...
def _cal(data):
    return EvriDeliveriesCalendar(_coordinator(data), _entry())
    ...
    cal = _cal(
        [
            _parcel(
                ...
                planned_from="2099-01-01T10:00:00Z",
                pickup=True,
                pickup_point="Evri Shop",
            )
        ]
    )
    assert cal._events()[0].location == "Evri Shop"
